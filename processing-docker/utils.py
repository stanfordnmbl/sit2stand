...
def json2np_new(json_dir, subjectid):
...
# subjectid, processed_npy_path="videos/np/"
def process_subject(keypoints_arr, framerate = None, subjectid = "new", plots_path = "/tmp"):
    res = keypoints_arr
